  ...
  return (
    <>
      ...
      <div className='flex-row-center mt-11 mb-7'>
        <form action="" className='w-[44%] bg-white flex-col-center p-5 rounded shadow gap-3'>
          <input type="text" placeholder='Enter title' className='outline-none border border-gray-300 p-1 rounded-xs text-sky-600 placeholder:text-gray-500'/>
